...
static void read_config(void)
{
	...
	cfg.textbox_transparent = FALSE;
	cfg.transparent_threshold = 0;
	...
	cfg.equalizer_x = 20;
	cfg.equalizer_y = 136;
	cfg.equalizer_transparent = FALSE;
	...
	if (cfgfile)
	{
		...
		xmms_cfg_read_boolean(cfgfile, "xmms", "vis_transparent", &cfg.vis_transparent);
		...
		xmms_cfg_read_boolean(cfgfile, "xmms", "textbox_transparent", &cfg.textbox_transparent);
		xmms_cfg_read_int(cfgfile, "xmms", "transparent_threshold", &cfg.transparent_threshold);
		...
		xmms_cfg_read_boolean(cfgfile, "xmms", "equalizer_transparent", &cfg.equalizer_transparent);
...
void save_config(void)
{
	...
	xmms_cfg_write_boolean(cfgfile, "xmms", "vis_transparent", cfg.vis_transparent);
	...
	xmms_cfg_write_boolean(cfgfile, "xmms", "textbox_transparent", cfg.textbox_transparent);
	xmms_cfg_write_int(cfgfile, "xmms", "transparent_threshold", cfg.transparent_threshold);
	...
	xmms_cfg_write_boolean(cfgfile, "xmms", "equalizer_transparent", cfg.equalizer_transparent);
...
static void mainwin_update_song_info(void)
{
	...
	sprintf(text, "%2d", (int)(frequency / 1000));
