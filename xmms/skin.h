...
typedef enum
{
	...
	SKIN_BALANCE, SKIN_MONOSTEREO, SKIN_PLAYPAUSE, SKIN_NUMBERS, SKIN_NUMBERS_NOMASK,
	SKIN_POSBAR, SKIN_PLEDIT, SKIN_EQMAIN, SKIN_EQ_EX,
} SkinIndex;
...
typedef struct
{
	...
	GdkBitmap *def_nums_mask[11];
	GdkBitmap *def_text_mask[31*3];
	...
	GdkBitmap *mask_nums[11];
	GdkBitmap *mask_text[31*3];
}
Skin;
